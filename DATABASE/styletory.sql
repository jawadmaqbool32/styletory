...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 14, 2022 at 08:51 PM
...
ALTER TABLE `booking`
  ...
  ADD KEY `vendor_service_id` (`service_id`),
  ADD KEY `vendorr_id` (`vendor_id`),
...
--
ALTER TABLE `vendor_services`
  MODIFY `vs_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
