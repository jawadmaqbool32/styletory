                                                ...
                                                <tr>
                                                    ...
                                                    >
                                                        <i class="fe fe-pencil"></i> Edit
                                                            ...
                                                            <a href="customer-information-edit.php?customer=<?php echo $row["id"] ?>" class="btn btn-sm bg-primary-light">
                                                                <i class="fe fe-pencil"></i> Edit
                                                            </a>
                                                            <a href="customer-information.php?customer=<?php echo $row["id"] ?>" class="btn btn-sm bg-success-light">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-content p-2">
                                                                    ...
                                                                    <a href="delete-customer.php?id=<?php echo $row["id"]; ?>"><button type="submit" class="btn btn-danger"> Delete</button></a>
                                                                </div>
                                                                </form>
                                                            </div>
                                                        </div>
