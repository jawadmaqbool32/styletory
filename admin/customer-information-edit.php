...
<head>
    ...
    <title>StyleTory - Edit Customer Details</title>
                        ...
                        <div class="card card-table">
                            <div class="card-body p-4">
                                ...
                                if (isset($_REQUEST['update'])) {
                                    ...
                                    $check_query  = "SELECT * FROM `customer` where `email` = '$email' AND `id` !=" . $_GET['customer'];
                                    $check_query2  = "SELECT * FROM `customer` where `username` = '$username' AND `id` != " . $_GET['customer'];
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" required value="<?php echo ucwords($customer['fullname']) ?>" name="name" id="" class="form-control" placeholder="Name here..." aria-describedby="helpId">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="" class="form-label">Username <span class="text-danger">*</span></label>
                                                <input type="text" required value="<?php echo ($customer['username']) ?>" name="username" id="" class="form-control" placeholder="Username here..." aria-describedby="helpId">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="" class="form-label">Contact <span class="text-danger">*</span></label>
                                                <input type="text" required value="<?php echo ($customer['phoneNo']) ?>" name="phoneNo" id="" class="form-control" placeholder="Contact here..." aria-describedby="helpId">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="" class="form-label">Email <span class="text-danger">*</span></label>
                                                <input type="email" required value="<?php echo ($customer['email']) ?>" name="email" id="" class="form-control" placeholder="Email here..." aria-describedby="helpId">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="" class="form-label">Age <span class="text-danger">*</span></label>
                                                <input type="number" required value="<?php echo ($customer['age']) ?>" name="age" id="" class="form-control" placeholder="Age here..." aria-describedby="helpId">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="" class="form-label">DOB <span class="text-danger">*</span></label>
                                                <input type="date" required value="<?php echo ($customer['dob']) ?>" name="dob" id="" class="form-control" placeholder="DOB here..." aria-describedby="helpId">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="" class="form-label">City <span class="text-danger">*</span></label>
                                                <input type="text" required value="<?php echo ($customer['city']) ?>" name="city" id="" class="form-control" placeholder="City here..." aria-describedby="helpId">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="" class="form-label">Address <span class="text-danger">*</span></label>
                                                <input type="text" required value="<?php echo ($customer['address']) ?>" name="address" id="" class="form-control" placeholder="Address here..." aria-describedby="helpId">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
