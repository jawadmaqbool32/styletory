...
<html lang="en">
	...
	<!-- styletory/appointments.php  30 Nov 2019 04:12:09 GMT -->
						...
						<div class="col-md-7 col-lg-8 col-xl-9">
							<div class="appointments">
								...
								<div class="appointment-list">
									<div class="profile-info-widget">
										<a href="#" class="booking-doc-img">
											<img src="assets/img/patients/customer-1.jpg" alt="User Image">
										</a>
										<div class="profile-det-info">
											<h3><a href="#">Muhammad Hamza</a></h3>
											<div class="patient-details">
												<h5><i class="far fa-clock"></i> 14 Nov 2021, 10.00 AM</h5>
												<h5><i class="fas fa-map-marker-alt"></i> Punjab, Pakistan</h5>
												<h5><i class="fas fa-envelope"></i> hamza@example.com</h5>
												<h5 class="mb-0"><i class="fas fa-phone"></i> +92 330-7879872</h5>
											</div>
										</div>
									</div>
								...
								<div class="appointment-list">
									<div class="profile-info-widget">
										<a href="#" class="booking-doc-img">
											<img src="assets/img/patients/customer-2.jpg" alt="User Image">
										</a>
										<div class="profile-det-info">
											<h3><a href="#">Zahra Gohar </a></h3>
											<div class="patient-details">
												<h5><i class="far fa-clock"></i> 12 Nov 2021, 5.00 PM</h5>
												<h5><i class="fas fa-map-marker-alt"></i> KPK, Pakistan
												</h5>
												<h5><i class="fas fa-envelope"></i> zahra@example.com</h5>
												<h5 class="mb-0"><i class="fas fa-phone"></i> +92 330-3013334</h5>
											</div>
										</div>
									</div>
									<div class="appointment-action">
