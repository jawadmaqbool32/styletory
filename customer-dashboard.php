                  ...
                  <div class="card-body pt-0">
                    ...
                    <nav class="user-tabs mb-4">
                      <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" href="#pat_medical_records" data-toggle="tab"><span class="med-records">My
                              Records</span></a>
                        </li>
                            ...
                            <div class="table-responsive">
                              <table class="table table-hover table-center mb-0">
                                ...
                                <tbody>
                                  ...
                                  $customer_query = mysqli_query($con, "SELECT * FROM `customer` WHERE username = '" . $_SESSION['username'] . "'");
                                  $customer = mysqli_fetch_array($customer_query)['id'];
                                  $booking_query = mysqli_query($con, "SELECT * FROM  `booking`   WHERE `customer_id` = '$customer'");
                                  while ($booking =  mysqli_fetch_array($booking_query)) {
                                    $vendor_query = mysqli_query($con, "SELECT * FROM `vendor` WHERE `id` = '" . $booking['vendor_id'] . "'");
                                    ...
                                    $speciality_query = mysqli_query($con, "SELECT * FROM `services` WHERE `id` = '" . $member['speciality'] . "'");
                                    $speciality = mysqli_fetch_array($speciality_query);
                                  ...
                                  ?>
                                    <tr>
                                      <td>
                                        <h2 class="table-avatar">
                                          <a href="#" class="avatar avatar-sm mr-2">
                                            <img class="avatar-img rounded-circle" src="admin/upload/<?php echo $vendor['image'] ?>" alt="User Image" />
                                          </a>
                                          <a href="#"><?php echo $vendor['fullname'] ?><span><?php echo $service['name'] ?></span></a>
                                        </h2>
                                      </td>
                                      <td>
                                      ...
                                      <td>
                                        ...
                                        <span class="d-block text-info"><?php echo date('h:i A', strtotime($booking['time_from'])) ?></span>
                                      </td>
                                      ...
                                      <td>
                                        ...
                                        ?>
                                          <span class="badge badge-pill bg-warning-light"><?php echo $booking['status']  ?></span>
                                        <?php
                                        } elseif ($booking['status'] == 'approved') {
                                        ?>
                                          <span class="badge badge-pill bg-success-light"><?php echo $booking['status']  ?></span>
                                        <?php
                                        } elseif ($booking['status'] == 'rejected') {
                                        ?>
                                          <span class="badge badge-pill bg-danger-light"><?php echo $booking['status']  ?></span>
                                        <?php
                                        }
                                        ?>
                                      </td>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <h2 class="table-avatar">
                                      <a href="#" class="avatar avatar-sm mr-2">
                                        <img class="avatar-img rounded-circle" src="assets/img/doctors/a4.jpg" alt="User Image" />
                                      </a>
                                      <a href="#">Tariq Amin
                                      </a>
                                    </h2>
