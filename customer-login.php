...
if(isset($_SESSION['username'])) {
    header("Location:customer-dashboard.php"); // redirects them to homepage
...
?>
	<head>
		...
		<title>StyleTory- Customer Login</title>
			...
			<header class="header">
				<nav class="navbar navbar-expand-lg header-nav">
					...
					<ul class="nav header-navbar-rht">
						...
						<li class="nav-item">
							<a class="nav-link header-login" href="customer-register.php"> Signup </a>
						</li>
					</ul>
				</nav>
			</header>
							...
							<div class="account-content">
								<div class="row align-items-center justify-content-center">
									<div class="col-md-7 col-lg-6 login-left">
										<img src="assets/img/customer-register.png" class="img-fluid" alt="styletory Login">
									</div>
									<div class="col-md-12 col-lg-6 login-right">
										...
										<form  method="post" name="login">
											...
											<div class="text-right">
												<a class="forgot-link" href="customer-forgot-password.php">Forgot Password?</a>
											</div>
											<button class="btn btn-primary btn-block btn-lg login-btn" name="save" type="submit">Login
											</button>
											<div class="text-center dont-have">Register as a Vendor?<a href="vendor-login.php"> Vendor Login</a></div>
											<div class="login-or">
												<span class="or-line"></span>
												<span class="span-or">or</span>
											</div>
											<div class="text-center dont-have">Don’t have an customer account? <a href="customer-register.php">Register</a></div>
										</form>
									</div>
								</div>
							</div>
