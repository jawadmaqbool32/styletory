...
include ("db.php");
	if(isset($_REQUEST['send']))
    {
        if($_SESSION['otp']==$_POST['otp'])
        {
                ...
                echo '<script>window.location.href="customer-recover-pass.php"</script>";';
        }else{
								...
								<div class="row align-items-center justify-content-center">
									...
									<div class="col-md-12 col-lg-6 login-center">                                    
										<div class="login-header">
											<h2>Enter OPT for VENDOR Account</h2>
										</div>										
										<!-- Forgot Password Form -->
										<form action="" method="POST" name="myform">
                                            
                                            <div class="form-group form-focus">
												<input type="number" maxlength="10" class="form-control floating" name="otp">
												<label class="focus-label"><i class="fa fa-check" aria-hidden="true"> OTP</label></i>
                                            </div>
											<button class="btn btn-primary btn-block btn-lg login-btn" type="submit"  name="send" onclick="return Validate()">Save</button>
										</form>
										<!-- /Forgot Password Form -->
