...
<html lang="en">
  ...
  <head>
    ...
    <title>StyleTory - Saloon Profile</title>
							...
							<div class="doctor-widget">
								<div class="doc-info-left">
									<div class="doctor-img">
										<img class="img-fluid" src="<?php echo "admin/upload/" .$row["image"]; ?>" onerror="this.src='assets/img/avatar.png'" alt="User Image">
									</div>
									<div class="doc-info-cont">
										<h4 class="doc-name mb-2"><?php echo $row["fullname"];?></h4>
										<p class="doc-speciality"><i class="fa fa-check" aria-hidden="true"></i>
										<?php echo $row["services"];?></p>
										...
										<div class="clinic-details">
											<p class="doc-location"><i class="fas fa-map-marker-alt"></i> <?php echo $row["address"];?>
								...
								<div class="doc-info-right">
									...
									<div class="clinic-booking">
										...
										<!-- <a class="apt-btn " href="book-slot.php?id=<?php echo $row["id"];?>">Book Appointment</a> -->
										<a class="view-pro-btn mt-5" href="booking.php">Go Back</a>
									</div>
								</div>
							</div>
						</div>
										...
										<div class="col-md-12 col-lg-9">
												...
												<div class="experience-box">
													<ul class="experience-list">
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	<p class="exp-year"><?php echo $row["award_year"];?></p>
																	<h4 class="exp-title"><?php echo $row["awards"];?></h4>
																</div>
															</div>
														</li>
													</ul>
											...
											<div class="clini-infos">
												<ul class="clearfix">
													...
													<li><i class="fa fa-trophy" aria-hidden="true"></i><?php echo $row["specialization"]; ?></li>
