...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-lg-8 col-xl-9">
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="mb-3">Service Fares </h2>
                                <?php
                                                ...
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <table class="table table-hover table-center mb-0">
                                                            ...
                                                            <?php
                                                            $res1 = mysqli_query($con, "SELECT id INTO @id FROM vendor  WHERE username = '" . $_SESSION['username'] . "'");
                                                            $res = mysqli_query($con, "SELECT vendor_services.vs_id,services.name, vendor_services.price, vendor_services.time
                                                            FROM services
                                                            JOIN vendor_services 
                                                            ON services.id=vendor_services.services_id
                                                            WHERE vendor_services.vendors_id=@id");
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center">
                                                                            <div class="table-action">
                                                                                <button class="btn btn-sm bg-info-light" data-toggle="modal" href="#update_service<?php echo $row['vs_id']; ?>">
                                                                                    <i class="fas fa-edit"></i> Edit
                                                                                </button>
                                                                                <button class="btn btn-sm bg-danger-light" data-toggle="modal" href="#delete_service">
    ...
    <!-- /Main Wrapper -->
    <?php
    $res = mysqli_query($con, "SELECT * from vendor_services");
    $num_rows = mysqli_num_rows($res);
    while ($row = mysqli_fetch_array($res)) {
    ?>

        <!-- Update_service Modal -->
        <div class="modal fade custom-modal" id="update_service<?php echo $row['vs_id']; ?>">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="update_vendor_services.php?id=<?php echo $row['vs_id']; ?>" method="POST">
                                        ...
                                        <div class="row form-row">
                                            <div class="col-6 col-md-6">
                                                <div class="form-group form-focus">
                                                    <input type="hidden" name="vs_id" value="<?php echo $row["vs_id"]; ?>">
                                                    <input type="number" maxlength="40" class="form-control floating" name="price" value="<?php echo $row["price"]; ?>" required>
                                                    <label class="focus-label">Edit Price</label>
                                                </div>
                                            </div>
                                            <div class="col-6 col-md-6">
                                                <div class="form-group form-focus">
                                                    <input type="number" maxlength="40" class="form-control floating" name="time" value="<?php echo $row["time"]; ?>" required>
                                                    <label class="focus-label">Edit Time (min)</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="submit-section text-center">
                                <a href="update_vendor_services.php?id=<?php echo $row["vs_id"]; ?>"><button type="submit" name="update" class="btn btn-info">Update</button></a>
        ...
        <!-- delete_service Modal -->
        <div class="modal fade custom-modal" id="delete_service">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body text-center">
                        <h4 class="modal-title">Delete</h4>
                        <p class="mb-3">Are you sure want to delete service?</p>
                        <div class="submit-section text-center">
                            <button type="submit" data-dismiss="modal" class="btn btn-info">Cancel</button>
                            <a href="delete_vendor_services.php?id=<?php echo $row["vs_id"]; ?>"><button type="submit" class="btn btn-danger"> Delete</button></a>
                        </div>
                    </div>
                </div>
            </div>
